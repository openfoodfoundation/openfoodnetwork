...
Rails.application.configure do
  ...
  config.enable_reloading = !ENV.fetch("PROFILE", false)
  ...
  if Rails.root.join("tmp/caching-dev.txt").exist? || !!ENV.fetch("PROFILE", false) || !!ENV.fetch("DEV_CACHING", false)
  ...
  config.assets.digest = !!ENV.fetch("PROFILE", false)
