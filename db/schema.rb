...
ActiveRecord::Schema.define(version: 20_151_125_051_510) do
  ...
  add_index 'cms_blocks', %w(page_id identifier), name: 'index_cms_blocks_on_page_id_and_identifier'
  ...
  add_index 'cms_categories', %w(site_id categorized_type label), name: 'index_cms_categories_on_site_id_and_categorized_type_and_label', unique: true
  ...
  add_index 'cms_categorizations', %w(category_id categorized_type categorized_id), name: 'index_cms_categorizations_on_cat_id_and_catd_type_and_catd_id', unique: true
  ...
  add_index 'cms_files', %w(site_id block_id), name: 'index_cms_files_on_site_id_and_block_id'
  add_index 'cms_files', %w(site_id file_file_name), name: 'index_cms_files_on_site_id_and_file_file_name'
  add_index 'cms_files', %w(site_id label), name: 'index_cms_files_on_site_id_and_label'
  add_index 'cms_files', %w(site_id position), name: 'index_cms_files_on_site_id_and_position'
  ...
  add_index 'cms_layouts', %w(parent_id position), name: 'index_cms_layouts_on_parent_id_and_position'
  add_index 'cms_layouts', %w(site_id identifier), name: 'index_cms_layouts_on_site_id_and_identifier', unique: true
  ...
  add_index 'cms_pages', %w(parent_id position), name: 'index_cms_pages_on_parent_id_and_position'
  add_index 'cms_pages', %w(site_id full_path), name: 'index_cms_pages_on_site_id_and_full_path'
  ...
  add_index 'cms_revisions', %w(record_type record_id created_at), name: 'index_cms_revisions_on_record_type_and_record_id_and_created_at'
  ...
  add_index 'cms_snippets', %w(site_id identifier), name: 'index_cms_snippets_on_site_id_and_identifier', unique: true
  add_index 'cms_snippets', %w(site_id position), name: 'index_cms_snippets_on_site_id_and_position'
  ...
  add_index 'customers', %w(enterprise_id code), name: 'index_customers_on_enterprise_id_and_code', unique: true
  ...
  add_index 'enterprise_relationships', %w(parent_id child_id), name: 'index_enterprise_relationships_on_parent_id_and_child_id', unique: true
  ...
  add_index 'enterprise_roles', %w(enterprise_id user_id), name: 'index_enterprise_roles_on_enterprise_id_and_user_id', unique: true
  add_index 'enterprise_roles', ['enterprise_id'], name: 'index_enterprise_roles_on_enterprise_id'
  add_index 'enterprise_roles', %w(user_id enterprise_id), name: 'index_enterprise_roles_on_user_id_and_enterprise_id', unique: true
  ...
  add_index 'enterprises', %w(is_primary_producer sells), name: 'index_enterprises_on_is_primary_producer_and_sells'
  ...
  add_index 'spree_assets', %w(viewable_type type), name: 'index_assets_on_viewable_type_and_type'
  ...
  add_index 'spree_configurations', %w(name type), name: 'index_configurations_on_name_and_type'
  ...
  add_index 'spree_option_values_variants', %w(variant_id option_value_id), name: 'index_option_values_variants_on_variant_id_and_option_value_id'
  ...
  add_index 'spree_tokenized_permissions', %w(permissable_id permissable_type), name: 'index_tokenized_name_and_type'
  ...
  add_index 'variant_overrides', %w(variant_id hub_id), name: 'index_variant_overrides_on_variant_id_and_hub_id'
