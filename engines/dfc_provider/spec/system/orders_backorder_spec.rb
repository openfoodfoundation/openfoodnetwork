...
RSpec.describe "Orders backorder integration" do
  ...
  # The distributor must be authorised with the email address of the supplier owner. Because they are on the same OFN instance in this test, they must be the same user.
  ...
  let(:order) {
    create(:order_with_totals_and_distribution, :with_line_item, variant: distributor_variant,
