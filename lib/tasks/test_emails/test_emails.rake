...
namespace :test do
  ...
  def run_email_test_suite
    ...
    # Set the from address for this rake task
    #ActionMailer::Base.default from: 'test@staging.openfoodnetwork.org.au'
    #puts "\nFrom address successfully set..."
