      ...
      def respond_with_error(errors)
        ...
        respond_to do |format|
          format.html {
            ...
            # Neither path re-renders a modal: create posts from the uploader on the
            # product/variant edit page (there's no standalone HTML form any more), and
            # update posts from the image edit page. Both send the error back as a flash.
