...
Spree::Admin::OrdersController.class_eval do
  ...
  before_action :load_spree_api_key, only: :bulk_management
  ...
  before_action :check_authorization, except: [:bulk_management, :managed]
  ...
  def index
    ...
    unless params[:q][:created_at_gt].blank?
