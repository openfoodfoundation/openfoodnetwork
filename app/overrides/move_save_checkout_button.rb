...
Deface::Override.new(:virtual_path  => "spree/checkout/edit",
                     ...
                     :text          => '<div id="add_new_save_checkout_button" class="columns omega four" style="margin-top: 30px; padding-top:10px; border-top: 1px solid #d9d9db;">
...
Deface::Override.new(:virtual_path  => "spree/checkout/edit",
                     ...
                     :text          => '<script type="text/javascript">
                                          ...
                                          {
                                            alert("non html5 brwowser doesnt support form attribute");
