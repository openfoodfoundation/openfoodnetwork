...
class Customer < ApplicationRecord
  ...
  enum :customer_type, individual: "individual", enterprise: "enterprise",
       default: "individual"
  ...
  validates :enterprise_name, presence: true, length: { maximum: 128 }, if: :enterprise?
  validates :enterprise_acn, presence: true, length: { maximum: 64 }, if: :enterprise?
