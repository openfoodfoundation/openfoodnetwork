...
module Reporting
  module Reports
    module OrdersAndFulfillment
      describe OrdersAndFulfillmentReport do
        ...
        describe "order_cycle_customer_totals" do
          ...
          before do
            ...
            order.line_items << build(:line_item_with_shipment, variant: fuji, price: nil,
                                                                quantity: 1)
            order.line_items << build(:line_item_with_shipment, variant: gala, price: nil,
                                                                quantity: 2)
          end
