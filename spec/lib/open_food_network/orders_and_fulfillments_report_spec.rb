  ...
  describe OrdersAndFulfillmentsReport do
    ...
    describe "columns are aligned" do
      ...
      it 'has aligned columns' do
        report_types = %w(order_cycle_supplier_totals order_cycle_supplier_totals_by_distributor
                          order_cycle_distributor_totals_by_supplier order_cycle_customer_totals)
