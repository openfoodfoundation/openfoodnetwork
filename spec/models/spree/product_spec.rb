    ...
    describe "validations and defaults" do
      ...
      describe "permalink" do
        ...
        it "generates a unique permalink" do
          product1 = create(:product, name: "Banana Permanenta", slug: nil)
          product2 = create(:product, name: "Banana Permanenta", slug: nil)
          expect(product2.slug).to_not eq product1.slug
