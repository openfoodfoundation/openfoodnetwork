...
RSpec.describe 'Groups' do
  ...
  describe "producers" do
    describe "filtering by product property" do
      ...
      let!(:product1) { create(:simple_product, enterprise_id: producer1.id) }
      let!(:product2) { create(:simple_product, enterprise_id: producer2.id) }
  ...
  describe "hubs" do
    describe "filtering by product property" do
      ...
      let(:p1) { create(:simple_product, enterprise_id: producer.id) }
      ...
      let(:p4) { create(:simple_product, enterprise_id: create(:supplier_enterprise).id) }
