...
RSpec.describe "full-page cart" do
  ...
  describe "viewing the cart" do
    ...
    let(:product_with_tax) {
      create(:taxed_product, enterprise_id: supplier.id, zone:, price: 110.00, tax_rate_amount: 0.1,
                             included_in_price: true)
    }
    let(:product_with_fee) {
      create(:simple_product, enterprise_id: supplier.id, price: 0.86, on_hand: 100)
    }
