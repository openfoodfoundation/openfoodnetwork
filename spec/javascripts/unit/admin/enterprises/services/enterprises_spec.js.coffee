  ...
  describe "#removeLogo", ->
    ...
    describe "success", ->
      ...
      beforeEach ->
        ...
        $httpBackend.expectDELETE("/api/legacy/enterprises/enterprise1/logo.json").respond 200, { id: 15, name: "Enterprise 1"}
    ...
    describe "failure", ->
      ...
      beforeEach ->
        enterprise = new EnterpriseResource( { id: 15, permalink: "enterprise1", name: "Enterprise 1" } )
        $httpBackend.expectDELETE("/api/legacy/enterprises/enterprise1/logo.json").respond 409, { error: "obj" }
  ...
  describe "#removePromoImage", ->
    ...
    describe "success", ->
      ...
      beforeEach ->
        ...
        $httpBackend.expectDELETE("/api/legacy/enterprises/enterprise1/promo_image.json").respond 200, { id: 15, name: "Enterprise 1"}
    ...
    describe "failure", ->
      ...
      beforeEach ->
        enterprise = new EnterpriseResource( { id: 15, permalink: "enterprise1", name: "Enterprise 1" } )
        $httpBackend.expectDELETE("/api/legacy/enterprises/enterprise1/promo_image.json").respond 409, { error: "obj" }
