...
RSpec.describe Spree::ShipmentMailer do
  ...
  include_examples 'email header without white labelling', :shipment_email
  include_examples 'is affected by white labelling', :shipment_email
  include_examples 'email header without white labelling', :picked_up_email
  include_examples 'is affected by white labelling', :picked_up_email
