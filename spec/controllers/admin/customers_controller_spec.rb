  ...
  describe CustomersController, type: :controller do
      ...
      context "json" do
        ...
        context "where I manage the customer's enterprise" do
          ...
          it "allows me to update the customer" do
            put :update, format: :json, id: customer.id, customer: { email: 'new.email@gmail.com' }
    ...
    describe "create" do
      ...
      def create_customer(enterprise)
        put :create, format: :json, customer: { email: 'new@example.com', enterprise_id: enterprise.id }
      end
